...
set(ANDROID_TEST_PACKAGE_ROOT ${REPO_ROOT}/java/src/test/android)
set(ANDROID_TEST_PACKAGE_OUTPUT_DIR ${ANDROID_TEST_PACKAGE_ROOT}/app/build)
...
if (CMAKE_SYSTEM_NAME STREQUAL "Android")
  ...
  add_custom_command(TARGET onnxruntime4j_jni POST_BUILD COMMAND ${CMAKE_COMMAND} -E create_symlink $<TARGET_FILE:onnxruntime4j_jni> ${ANDROID_TEST_PACKAGE_ROOT}/$<TARGET_LINKER_FILE_NAME:onnxruntime4j_jni>)
endif()
...
if (CMAKE_SYSTEM_NAME STREQUAL "Android")
  ...
  add_custom_command(TARGET onnxruntime4j_jni POST_BUILD COMMAND ${GRADLE_EXECUTABLE} -b build-android.gradle -c settings-android.gradle build -DjniLibsDir=${ANDROID_PACKAGE_JNILIBS_DIR} -DbuildDir=${ANDROID_TEST_PACKAGE_OUTPUT_DIR} WORKING_DIRECTORY ${ANDROID_TEST_PACKAGE_ROOT})
endif()
